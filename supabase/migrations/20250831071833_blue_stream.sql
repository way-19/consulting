-- Drop all custom tables and reset database to clean state
...
-- Note: This script only drops custom tables and functions
-- Supabase auth tables (auth.users, etc.) will remain intact