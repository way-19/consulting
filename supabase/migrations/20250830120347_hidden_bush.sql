/*
  ...
  1. Sample Data
    - Add sample content for about_page
    - Include English, Turkish, and Portuguese content
    - Add SEO meta data
...
-- Insert sample about_page content if it doesn't exist
INSERT INTO marketing_pages (
  ...
  '{
    ...
    "values_description": "Os princípios que guiam nossa abordagem à consultoria empresarial internacional",
  ...
  'consulting19, about, international business, AI consulting, global expansion',
  'Consulting19 Hakkında - AI Destekli Küresel İş Danışmanlığı',
  'Girişimcileri 19+ ülkede uzman danışmanlarla buluşturan AI destekli platform Consulting19 hakkında bilgi edinin.',
  'consulting19, hakkında, uluslararası iş, AI danışmanlık, küresel genişleme',
  'Sobre a Consulting19 - Consultoria Empresarial Global com IA',
  'Saiba sobre a Consulting19, a plataforma com IA que conecta empreendedores com consultores especialistas em 19+ países para expansão internacional de negócios.',
  'consulting19, sobre, negócios internacionais, consultoria IA, expansão global'
