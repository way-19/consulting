            ...
            <div className="space-y-4 p-4">
              <div>
                ...
                >
                  <option value="accounting_fee">Accounting Fee</option>
                  <option value="virtual_office_fee">Virtual Office Fee</option>
                  <option value="tax_payment">Tax Payment (Client's Tax Obligation)</option>
                </select>
                ...
                {feeData.type === 'tax_payment' && (
                  <p className="text-xs text-red-600 mt-1">💰 Client's calculated tax obligation to government</p>
                )}
              </div>
