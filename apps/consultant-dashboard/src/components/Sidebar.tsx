...
const Sidebar = () => {
  ...
  const navigation = [
    ...
    { name: 'Country Management', href: '/country', icon: Globe },
    { name: 'Services', href: '/services', icon: Settings },
    { name: 'Content Pages', href: '/content', icon: FileText },
    { name: 'Blog Posts', href: '/blog', icon: MessageSquare },
    ...
    <div className="w-64 bg-white shadow-lg flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-gray-900">Consultant Portal</span>
        </div>
      </div>
