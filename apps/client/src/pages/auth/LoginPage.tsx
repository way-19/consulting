...
const LoginPage = () => {
  ...
  const handleMfaVerification = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!mfaCode.trim() || !mfaChallenge) return;
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900">
            {showMfaInput ? 'Two-Factor Authentication' : 'Welcome Back'}
          </h2>
          <p className="mt-2 text-gray-600">
            {showMfaInput ? 'Enter your verification code' : 'Sign in to your client account'}
          </p>
