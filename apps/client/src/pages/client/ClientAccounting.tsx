          ...
          <div className="p-6">
            {filteredDocuments.length > 0 ? (
              ...
              <div className="text-center py-12">
                <h4 className="text-sm font-semibold text-blue-900 mb-2">🤖 AI-Powered Processing & Task Creation</h4>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">No Documents Yet</h3>
                  Upload your financial documents and our AI will automatically categorize them.
                  Your consultant receives a task to review and process each document for your monthly accounting.
                </p>
