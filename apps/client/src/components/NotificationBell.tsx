...
Generated by Consulting19 Accounting System
  ...
  const getNotificationMessage = (notification: Notification) => {
    switch (notification.type) {
      ...
      case 'tax_payment_due':
        return `🔔 Vergi Ödemesi: ${notification.payload.tax_type || 'Vergi'} - $${notification.payload.amount || '0'} ${notification.payload.currency || 'USD'}`;
      case 'accounting_fee_due':
        return `💼 Muhasebe Ücreti: $${notification.payload.amount || '0'} ${notification.payload.currency || 'USD'}`;
      case 'virtual_office_fee_due':
        return `🏢 Sanal Ofis Ücreti: $${notification.payload.amount || '0'} ${notification.payload.currency || 'USD'}`;
      default:
