...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Admin dashboard'da kaldığımız için basit yönlendirme
      navigate('/');
    }
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h3 className="text-sm font-semibold text-blue-900 mb-2">Admin Test Account:</h3>
          ...
          <Card.Body>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <p className="text-center text-sm text-gray-600">
                Need access?{' '}
                <a href="mailto:admin@consulting19.com" className="text-blue-600 hover:text-blue-800 font-medium">
