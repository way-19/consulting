...
const InvestmentAdvisoryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-blue-600 text-white py-14 mt-16 overflow-hidden">
        {/* Animated Background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-16 relative">
          ...
          <Card hover className="max-w-4xl mx-auto overflow-hidden group relative bg-gradient-to-br from-teal-600 via-blue-600 to-emerald-600 text-white border-2 border-teal-200 hover:border-teal-300 transition-all duration-500 transform hover:scale-[1.02] hover:shadow-2xl">
            {/* Animated Background Pattern */}
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-4 left-4 w-16 h-16 border border-teal-300 rounded-full animate-pulse"></div>
              <div className="absolute bottom-4 right-4 w-12 h-12 border border-blue-300 rounded-lg rotate-45 animate-pulse delay-1000"></div>
              <div className="absolute top-1/2 left-1/4 w-8 h-8 border border-emerald-300 rounded-full animate-bounce delay-500"></div>
            </div>

            {/* Floating Property Icons */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
              <div className="absolute top-6 right-6 text-2xl animate-float">🏠</div>
              <div className="absolute top-12 left-6 text-lg animate-float-delayed">🏢</div>
              <div className="absolute bottom-6 right-1/3 text-lg animate-bounce delay-1000">🏗️</div>
              <div className="absolute bottom-8 left-1/3 text-base animate-pulse delay-500">💎</div>
            </div>
            ...
            <Card.Body className="p-12 relative z-10">
              <div className="text-center">
                ...
                <p className="text-lg text-teal-100 mb-8 leading-relaxed max-w-3xl mx-auto">
                ...
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 text-white font-bold px-12 py-4 text-lg shadow-2xl border-0 transform hover:scale-105 transition-all duration-300 relative overflow-hidden group"
                  icon={ExternalLink}
                  iconPosition="right"
