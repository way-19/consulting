...
const CountriesPage = () => {
  ...
  const allCountries = [
    ...
    },
    {
      ...
      available: false,
      featured: true,
      highlights: ['Delaware LLC', 'Global Market', 'Strong Legal', 'Banking Access'],
      services: ['LLC Formation', 'Tax Planning', 'Banking', 'Legal Services'],
      consultant: null,
      description: 'World\'s largest economy with comprehensive business opportunities.',
      link: '#',
    },
    {
      id: 'malta',
