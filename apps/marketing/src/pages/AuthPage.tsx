...
import { useAuth } from '@consulting19/shared/auth';
    ...
    try {
      if (mode === 'register') {
        ...
        if (error) {
          ...
          window.location.href = `${dashboardUrl}/${formData.role}`;
        }
      } else {
        ...
        if (error) {
          ...
          if (redirectPath.startsWith('/consultant/') || redirectPath.startsWith('/auth')) {
            // Stay on marketing site for consultant profiles
