    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className={`max-w-4xl transition-all duration-1000 ${isLoaded ? 'animate-slide-up' : 'opacity-0 translate-y-10'}`}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-1000 delay-300 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card 
                key={index} 
                hover 
                className={`text-center h-full transition-all duration-500 delay-${(index + 1) * 100} ${isLoaded ? 'animate-scale-in' : 'opacity-0 scale-95'}`}
              >
                <Card.Body>
