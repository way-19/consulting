...
const translations = {
  en: {
    ...
    companyFormationDesc: 'End-to-end company registration and incorporation in business-friendly jurisdictions.',
    companyRegistration: 'Company registration',
    businessLicenses: 'Business licenses',
    corporateStructureSetup: 'Corporate structure setup',
    registeredAgent: 'Registered agent',
    virtualOffice: 'Virtual office',
    
    taxOptimization: 'Tax Optimization',
    taxOptimizationDesc: 'Strategic international tax planning to minimize legal tax liability across jurisdictions.',
    intlTaxPlanning: 'Intl. tax planning',
    doubleTaxTreaty: 'Double tax treaty',
    taxResidencyPlanning: 'Tax residency planning',
    transferPricing: 'Transfer pricing',
    annualCompliance: 'Annual compliance',
    
    bankingSolutions: 'Banking Solutions',
    bankingSolutionsDesc: 'Global banking support for opening and managing corporate accounts.',
    ...
    legalCompliance: 'Legal Compliance',
    legalComplianceDesc: 'Ongoing legal and regulatory support to keep your business compliant.',
    complianceMonitoring: 'Compliance monitoring',
    contractReview: 'Contract review',
    legalStructureOptimization: 'Legal structure optimization',
    ipProtection: 'IP protection',
    dataProtection: 'Data protection',
    
    assetProtection: 'Asset Protection',
    assetProtectionDesc: 'Trusts, foundations, and holding structures to protect assets and reduce risk.',
    protectionStrategy: 'Protection strategy',
    trustFoundationSetup: 'Trust/foundation setup',
    riskMitigation: 'Risk mitigation',
    estatePlanning: 'Estate planning',
    insuranceCoordination: 'Insurance coordination',
    
    investmentAdvisory: 'Investment Advisory',
    investmentAdvisoryDesc: 'Tailored, globally diversified strategies across public and private markets.',
    portfolioManagement: 'Portfolio management',
    alternatives: 'Alternatives',
    realEstate: 'Real estate',
    esgMandates: 'ESG mandates',
    cryptoCompliance: 'Crypto compliance',
    
    visaResidency: 'Visa & Residency',
    visaResidencyDesc: 'End-to-end visa and residency solutions for founders, investors, and their families.',
    eligibilityReview: 'Eligibility review',
    countryComparison: 'Country comparison',
    applicationPreparation: 'Application preparation',
    documentFiling: 'Document filing',
    statusTracking: 'Status tracking',
    
    marketResearch: 'Market Research',
    marketResearchDesc: 'In-depth market and competitive analysis for successful international expansion.',
    tamSegmentation: 'TAM & segmentation',
    competitorMapping: 'Competitor mapping',
    pricingInsights: 'Pricing insights',
    goToMarketTesting: 'Go-to-market testing',
  ...
  tr: {
    ...
    companyFormationDesc: 'İş dostu yargı alanlarında uçtan uca şirket kaydı ve kuruluş hizmetleri.',
    companyRegistration: 'Şirket kaydı',
    businessLicenses: 'İş lisansları',
    corporateStructureSetup: 'Kurumsal yapı kurulumu',
    registeredAgent: 'Kayıtlı temsilci',
    virtualOffice: 'Sanal ofis',
    
    taxOptimization: 'Vergi Optimizasyonu',
    taxOptimizationDesc: 'Yargı alanları boyunca yasal vergi yükümlülüğünü minimize etmek için stratejik uluslararası vergi planlaması.',
    intlTaxPlanning: 'Uluslararası vergi planlaması',
    doubleTaxTreaty: 'Çifte vergilendirme anlaşması',
    taxResidencyPlanning: 'Vergi ikameti planlaması',
    transferPricing: 'Transfer fiyatlandırması',
    annualCompliance: 'Yıllık uyumluluk',
    
    bankingSolutions: 'Bankacılık Çözümleri',
    bankingSolutionsDesc: 'Kurumsal hesapları açma ve yönetme için küresel bankacılık desteği.',
    accountOpening: 'Hesap açma',
    multiCurrency: 'Çok para birimli',
    paymentGateways: 'Ödeme geçitleri',
    bankingRelationships: 'Bankacılık ilişkileri',
    tradeFinance: 'Ticaret finansmanı',
    
    legalCompliance: 'Yasal Uyumluluk',
    legalComplianceDesc: 'İşinizi uyumlu tutmak için devam eden yasal ve düzenleyici destek.',
    complianceMonitoring: 'Uyumluluk izleme',
    contractReview: 'Sözleşme incelemesi',
    legalStructureOptimization: 'Yasal yapı optimizasyonu',
    ipProtection: 'Fikri mülkiyet korunması',
    dataProtection: 'Veri korunması',
    
    assetProtection: 'Varlık Koruma',
    assetProtectionDesc: 'Varlıkları korumak ve riski azaltmak için tröstler, vakıflar ve holding yapıları.',
    protectionStrategy: 'Koruma stratejisi',
    trustFoundationSetup: 'Tröst/vakıf kurulumu',
    riskMitigation: 'Risk azaltma',
    estatePlanning: 'Emlak planlaması',
    insuranceCoordination: 'Sigorta koordinasyonu',
    
    investmentAdvisory: 'Yatırım Danışmanlığı',
    investmentAdvisoryDesc: 'Kamu ve özel piyasalarda özel, küresel olarak çeşitlendirilmiş stratejiler.',
    portfolioManagement: 'Portföy yönetimi',
    alternatives: 'Alternatifler',
    realEstate: 'Gayrimenkul',
    esgMandates: 'ESG mandatları',
    cryptoCompliance: 'Kripto uyumluluğu',
    
    visaResidency: 'Vize ve İkamet',
    visaResidencyDesc: 'Kurucular, yatırımcılar ve aileleri için uçtan uca vize ve ikamet çözümleri.',
    eligibilityReview: 'Uygunluk incelemesi',
    countryComparison: 'Ülke karşılaştırması',
    applicationPreparation: 'Başvuru hazırlığı',
    documentFiling: 'Belge dosyalama',
    statusTracking: 'Durum takibi',
    
    marketResearch: 'Pazar Araştırması',
    marketResearchDesc: 'Başarılı uluslararası genişleme için derinlemesine pazar ve rekabet analizi.',
    tamSegmentation: 'TAM ve segmentasyon',
    competitorMapping: 'Rakip haritalama',
    pricingInsights: 'Fiyatlandırma içgörüleri',
    goToMarketTesting: 'Pazara giriş testi',
    localRegulations: 'Yerel düzenlemeler',
  ...
  pt: {
    ...
    companyFormationDesc: 'Serviços completos de registro e incorporação de empresa em jurisdições favoráveis aos negócios.',
    companyRegistration: 'Registro de empresa',
    businessLicenses: 'Licenças comerciais',
    corporateStructureSetup: 'Configuração de estrutura corporativa',
    registeredAgent: 'Agente registrado',
    virtualOffice: 'Escritório virtual',
    
    taxOptimization: 'Otimização Fiscal',
    taxOptimizationDesc: 'Planejamento fiscal internacional estratégico para minimizar responsabilidade fiscal legal em jurisdições.',
    intlTaxPlanning: 'Planejamento fiscal internacional',
    doubleTaxTreaty: 'Tratado de dupla tributação',
    taxResidencyPlanning: 'Planejamento de residência fiscal',
    transferPricing: 'Preços de transferência',
    annualCompliance: 'Conformidade anual',
    
    bankingSolutions: 'Soluções Bancárias',
    bankingSolutionsDesc: 'Suporte bancário global para abertura e gestão de contas corporativas.',
    accountOpening: 'Abertura de conta',
    multiCurrency: 'Multi-moeda',
    paymentGateways: 'Gateways de pagamento',
    bankingRelationships: 'Relacionamentos bancários',
    tradeFinance: 'Financiamento comercial',
    
    legalCompliance: 'Conformidade Legal',
    legalComplianceDesc: 'Suporte legal e regulatório contínuo para manter seu negócio em conformidade.',
    complianceMonitoring: 'Monitoramento de conformidade',
    contractReview: 'Revisão de contratos',
    legalStructureOptimization: 'Otimização de estrutura legal',
    ipProtection: 'Proteção de PI',
    dataProtection: 'Proteção de dados',
    
    assetProtection: 'Proteção de Ativos',
    assetProtectionDesc: 'Trusts, fundações e estruturas de holding para proteger ativos e reduzir riscos.',
    protectionStrategy: 'Estratégia de proteção',
    trustFoundationSetup: 'Configuração de trust/fundação',
    riskMitigation: 'Mitigação de riscos',
    estatePlanning: 'Planejamento patrimonial',
    insuranceCoordination: 'Coordenação de seguros',
    
    investmentAdvisory: 'Consultoria de Investimento',
    investmentAdvisoryDesc: 'Estratégias personalizadas e globalmente diversificadas em mercados públicos e privados.',
    portfolioManagement: 'Gestão de portfólio',
    alternatives: 'Alternativos',
    realEstate: 'Imóveis',
    esgMandates: 'Mandatos ESG',
    cryptoCompliance: 'Conformidade cripto',
    
    visaResidency: 'Visto e Residência',
    visaResidencyDesc: 'Soluções completas de visto e residência para fundadores, investidores e suas famílias.',
    eligibilityReview: 'Revisão de elegibilidade',
    countryComparison: 'Comparação de países',
    applicationPreparation: 'Preparação de aplicação',
    documentFiling: 'Arquivamento de documentos',
    statusTracking: 'Rastreamento de status',
    
    marketResearch: 'Pesquisa de Mercado',
    marketResearchDesc: 'Análise aprofundada de mercado e competitiva para expansão internacional bem-sucedida.',
    tamSegmentation: 'TAM e segmentação',
    competitorMapping: 'Mapeamento de concorrentes',
    pricingInsights: 'Insights de preços',
    goToMarketTesting: 'Teste de entrada no mercado',
