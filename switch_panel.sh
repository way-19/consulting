...
case $PANEL in
    "client")
        ...
        echo "✅ Client panel aktif: https://debug-monorepo.preview.emergentagent.com"
        ;;
    "consultant")
        ...
        sudo supervisorctl reread && sudo supervisorctl update
        sudo supervisorctl start frontend
        echo "✅ Consultant panel aktif: https://debug-monorepo.preview.emergentagent.com"
        ;;
    "admin")
        ...
        sudo supervisorctl reread && sudo supervisorctl update
        sudo supervisorctl start frontend
        echo "✅ Admin panel aktif: https://debug-monorepo.preview.emergentagent.com"
        ;;
    "marketing")
        ...
        sudo supervisorctl reread && sudo supervisorctl update
        sudo supervisorctl start frontend
        echo "✅ Marketing panel aktif: https://debug-monorepo.preview.emergentagent.com"
        ;;
    *)
