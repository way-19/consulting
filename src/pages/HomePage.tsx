          ...
          <div className="bg-gradient-to-br from-indigo-600/95 via-purple-600/90 to-blue-600/95 backdrop-blur-sm rounded-xl shadow-xl p-6 border border-indigo-300/30 hover:shadow-2xl hover:from-indigo-700/95 hover:via-purple-700/90 hover:to-blue-700/95 transition-all duration-500 relative overflow-hidden h-80">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs font-medium text-white">{t('companyFeature1')}</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                  <span className="text-blue-300 text-sm">🌍</span>
                </div>
                <span className="text-xs font-medium text-white">{t('companyFeature2')}</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-red-500 rounded-full flex items-center justify-center">
                  <span className="text-green-300 text-sm">✅</span>
                </div>
                <span className="text-xs font-medium text-white">{t('companyFeature3')}</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center">
                  <span className="text-orange-300 text-sm">👨‍💼</span>
                </div>
                <span className="text-xs font-medium text-white">{t('companyFeature4')}</span>
              </div>
            </div>
      ...
      <div className="relative z-10 p-6 h-full flex flex-col justify-between text-white">
        ...
        <div>
          ...
          <h2 className="text-xl font-bold mb-3 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
            {t('wealthTitle') || 'Matrix Wealth Platform'}
          </h2>
          
          <p className="text-blue-100 mb-4 text-sm leading-relaxed">
            {t('wealthSubtitle') || 'Ultra-high-net-worth private wealth management'}
          </p>
        </div>
        ...
        <div className="space-y-2 mb-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs font-medium">{t('wealthFeature1') || 'AI-driven analysis'}</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
              <span className="text-xs">🌍</span>
            </div>
            <span className="text-xs font-medium">{t('wealthFeature2') || 'Global opportunities'}</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-red-500 rounded-full flex items-center justify-center">
              <span className="text-xs">♾️</span>
            </div>
            <span className="text-xs font-medium">{t('wealthFeature3') || 'Unlimited potential'}</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 mb-2">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 text-center">
              <div className="text-xs font-bold text-yellow-400">{t('wealthStat1') || '$2.5B+ AUM'}</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 text-center">
              <div className="text-xs font-bold text-green-400">{t('wealthStat2') || '98% Success'}</div>
            </div>
          </div>
          ...
          >
            <span className="mr-1">✨</span>
            {t('wealthCta') || 'Explore Matrix Wealth'}
