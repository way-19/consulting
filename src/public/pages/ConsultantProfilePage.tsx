...
import { Star, MapPin, Calendar, MessageSquare, CheckCircle, Globe, DollarSign } from 'lucide-react';
import { supabase, CustomService, UserProfile } from '../../shared/lib/supabase';
...
const ConsultantProfilePage = () => {
  ...
  const fetchConsultantData = async () => {
    ...
    try {
      ...
      if (selectedCountry) {
        servicesQuery = servicesQuery.eq('country_id', selectedCountry);
      }
  ...
  const isClientOfConsultant = () => {
    return user && role === 'client'; // In real app, check if client is assigned to this consultant
  };
