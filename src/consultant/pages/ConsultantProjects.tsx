...
import { FolderOpen, Calendar, User, TrendingUp, Plus } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage client projects and track progress</p>
        </div>
        <Button icon={Plus}>
          Create Project
        </Button>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      <div className="flex items-center">
                        ...
                        <span>{project.client?.profile?.full_name}</span>
                      </div>
        ...
        <Card>
          <Card.Body className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Projects will appear here when clients purchase your services
            </p>
            <Button icon={Plus}>
