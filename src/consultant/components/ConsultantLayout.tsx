...
const ConsultantLayout: React.FC<ConsultantLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    { name: t('dashboard'), href: '/consultant', icon: Home },
    { name: 'Services', href: '/consultant/services', icon: Target },
    { name: t('clients'), href: '/consultant/clients', icon: Users },
    { name: t('projects'), href: '/consultant/projects', icon: FolderOpen },
    { name: 'Messages', href: '/consultant/messages', icon: MessageSquare },
    { name: 'Analytics', href: '/consultant/analytics', icon: BarChart3 },
    { name: 'Schedule', href: '/consultant/schedule', icon: Calendar },
    { name: t('settings'), href: '/consultant/settings', icon: Settings },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-white shadow-lg flex flex-col">
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="mb-3">
            <p className="text-sm font-medium text-gray-900">{profile?.full_name || 'Consultant'}</p>
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-600">Professional Consultant</span>
            </div>
          </div>
        </header>
